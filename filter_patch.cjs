...
code = code.replace(
  ...
  `            <div className="p-4 border-b border-[#1a1a1a]">
                ...
                <div className="w-full h-32 bg-[#1a1a1a] rounded-lg overflow-hidden flex items-center justify-center" style={{ backgroundImage: 'repeating-conic-gradient(#3f3f46 0% 25%, transparent 0% 50%)', backgroundSize: '16px 16px' }}>
                    <canvas 
